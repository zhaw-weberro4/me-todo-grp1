...
public class LeanToDo implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        this.dummyTask("Vereinsreise", "Fragen wann Vereinsreise stattfindet", "user", frage, verein, -1);
        this.dummyTask("Training", "Nachfragen wer ins Wochenendtraining kommt", "user", frage, verein, -1);
        this.dummyTask("Ferien", "Reisebüro besuchen für Feriendestination", "user", phone, someday, -1);
